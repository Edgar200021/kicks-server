import z from "zod";
import {BRAND_NAME_MAX_LENGTH, BRAND_NAME_MIN_LENGTH} from "@/features/admin/brand/const/index.js";
...
export type CreateBrandResponse = z.infer<
	typeof CreateBrandResponseSchema
>;